...
if("FALSE" STREQUAL "TRUE")
  ...
  set(openslam_gmapping_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel_isolated/openslam_gmapping)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /home/ubuntu/catkin_ws/install_isolated)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/install_isolated/${idir}'.  ${_report}")
    endif()
