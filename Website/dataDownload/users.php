...
$productResult = $db_handle->runQuery("select * from swift_users order by id desc");
...
<h2 style="text-align:center;">Registered Swift Users</h2>

<div id="table-container">
    <div class="btn">
        <button onclick="exportTableToExcel('tab', 'Swift-users')" id="btnExport" name='export'
